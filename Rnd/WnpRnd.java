...
public class ReqnoRespnoHelper
{
    ...
    {
        System.out.println(getReqno("nnsp"));
    }
    /**
     ...
     */
    public static String getReqno (String nnsp ,String seq)
    ...
    public static String getReqno (String onsp )
      throws ProcessingException
  {
   ...
   * @exception  ProcessingException  Thrown on errors.
   */
  public static String getRespno (String onsp )
      throws ProcessingException
  {
