...
public class FibonacciSoapBindingStub extends org.apache.axis.client.Stub implements fibonacci.ws.Fibonacci {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("", "calculateFibonacciReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[0] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("calculateFibonacciRange");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, false, false);
        oper.addParameter(param);
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:fibonacci", "ArrayOf_xsd_int"));
        oper.setReturnClass(int[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "calculateFibonacciRangeReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[1] = oper;
    ...
    public FibonacciSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("urn:fibonacci", "ArrayOf_xsd_int");
    ...
    public int calculateFibonacci(int in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:fibonacci", "calculateFibonacci"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(in0)});
  ...
  throw axisFaultException;
    ...
    public int[] calculateFibonacciRange(int in0, int in1) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:fibonacci", "calculateFibonacciRange"));
